A Container is the single running unit of packaged software which includes the application, and its libraries and dependencies such that it is able to run on any anywhere (Desktop, Data Center or Cloud).
